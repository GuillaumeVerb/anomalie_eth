...
# Définir le contenu du notebook
notebook = {
    "cells": [
        {
            "cell_type": "markdown",
        ...
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": ["## 4. Analyze Anomalous Transactions"]
        },
        {
            "cell_type": "code",
            "execution_count": None,
...
print("Le notebook a été créé avec succès dans notebooks/02_modeling.ipynb")